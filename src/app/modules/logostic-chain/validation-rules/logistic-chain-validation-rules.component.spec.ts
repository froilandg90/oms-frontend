...
import { LogisticChainValidationRulesComponent } from './logistic-chain-validation-rules.component';
...
describe('AppComponent', () => {
  ...
  it('should create the app', () => {
    const fixture = TestBed.createComponent(LogisticChainValidationRulesComponent);
